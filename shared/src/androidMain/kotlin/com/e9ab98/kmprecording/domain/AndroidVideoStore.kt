...
import com.e9ab98.kmprecording.service.AndroidStorageService
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow

class AndroidVideoStore(context: Context) : VideoStore {
    private val storageService = AndroidStorageService(context)
    ...
    override suspend fun saveRecordedSegment(segment: RecordedSegment): Result<VideoRecord> {
        ...
        val record = storageService.getVideoRecords().firstOrNull { it.filePath == segment.filePath }
